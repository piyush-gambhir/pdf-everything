// @ts-nocheck
import * as __fd_glob_9 from "../content/docs/workers.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"api-reference.mdx": __fd_glob_1, "architecture.mdx": __fd_glob_2, "configuration.mdx": __fd_glob_3, "deployment.mdx": __fd_glob_4, "index.mdx": __fd_glob_5, "quickstart.mdx": __fd_glob_6, "tools.mdx": __fd_glob_7, "troubleshooting.mdx": __fd_glob_8, "workers.mdx": __fd_glob_9, });